...
public class LifestyleController {
  ...
  public LifestyleController(LifestyleService service, KafkaTemplate<String, Object> kafka) {
  ...
  @GetMapping("/search")
  public Object filter(@RequestParam String query) {
    return service.filter(query);
  }

  @PostMapping
  public Object create(@RequestBody LifestyleItem item) {
    return service.create(item);
  }

  @PostMapping("/favorite")
  public String favorite(@RequestBody LifestyleItem item) {
    kafka.send("favorites", item);
    return "Queued to favorites";
  }
}